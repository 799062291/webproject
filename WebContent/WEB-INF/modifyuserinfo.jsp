			...
			<table width="100%" border="0" cellspacing="0">
				<tr>
					...
					<td><div style="text-align: right; margin: 5px 10px 5px 0px">
							<a href="${pageContext.request.contextPath }/index.do">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
								href="${pageContext.request.contextPath }/DispacherServlet.do?type=my">&nbsp;我的帐户</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;用户信息修改
						</div>
								...
								<td>
									...
									<table width="100%" border="0" cellspacing="2" class="upline">
										...
										<tr>
											...
											<td style="padding-left: 20px">${sessionScope.user.uname }</td>
											<td>&nbsp;</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td colspan="2"><input name="utel" type="text"
												class="textinput" value="${sessionScope.user.usex }" /></td>
										</tr>
										<tr>
											<td style="text-align: right">发货地址：</td>
											<td colspan="2"><input name="uaddress" type="text"
												class="textinput" value="${sessionScope.user.uaddress }" style="width: 350px" /></td>
										</tr>
										<tr>
									...
									<table width="100%" border="0" cellspacing="2" class="upline">
										<tr>
											...
											<td width="47%" style="width: 50%"><select name="aquestion"
										...
										<tr>
											...
											<td><input name="reemail" type="text" class="textinput" /></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											<td style="text-align: right">&nbsp;</td>
