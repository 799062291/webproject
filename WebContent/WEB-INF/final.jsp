        ...
        <tr>
          <td style="padding:20px; text-align:center"><table width="80%" border="0" cellspacing="0" style="margin-top:70px">
            <tr>
              ...
              <td style="padding-top:30px"><font style="font-weight:bold; color:#FF0000">已成功购买商品！请耐心等待发货！</font><br />
                <br />
               <a id="a1" href="${pageContext.request.contextPath }"><img src="${pageContext.request.contextPath }/images/gwc_jx.gif" border="0" /></a>  &nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath }/index.do"><font color="blue">返回首页</font></a></td>
            </tr>
          </table>          
            <p>&nbsp;</p>
            </td>
