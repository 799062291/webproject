...
<table width="100%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td style="width:25%"><input type="text" class="textinput" name="uemail" id="uemail"/></td>
    <td><img src="images/check_use.gif" width="111" height="24" id="checkemail"/></td>
    <td id="sp1"></td>
  ...
  <tr>
    ...
    <td><img src="images/check_use.gif" width="111" height="24" id="checkUname" /></td>
    <td id="sp"></td>
  </tr>
  <tr>
    ...
    <td><font color="#999999">密码设置至少6位，请区分大小写</font></td>
     ...
     <div style="color:red">密码长度错误</div>
    </c:if>
    </td>
  </tr>
  <tr>
...
<table width="80%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td style="width:30%"><input type="text" name="ucheckcode" class="textinput"/></td>
    <td align="left" id="img2"><img id="img1" src="${pageContext.request.contextPath }/Codeservlet.do" alt="" /></td>
    <td align="left" style="cursor: pointer"><a id="img3" >看不清？换一张</a></td>
    <td>
...
<table width="70%" border="0" cellspacing="0">
  <tr>
    <td style="padding-top:20px; text-align:center"><input type="image" src="images/signup.gif"></input></td>
