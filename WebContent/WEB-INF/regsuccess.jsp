  ...
  <tr>
    <td style="padding:30px; text-align:center"><table width="60%" border="0" cellspacing="0" style="margin-top:70px">
      <tr>
        ...
        <td style="padding-top:30px"><font style="font-weight:bold; color:#FF0000">注册成功（账户未激活）</font><br />
            <br />
          <a href="index.html">请前往邮箱点击邮件激活账号 , <div id="num" style="display:inline">5</div>秒后自动为您转跳回首页</a></td>
      </tr>
    </table>
    <h1>&nbsp;</h1></td>
    </tr>
