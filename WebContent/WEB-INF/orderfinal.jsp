          ...
          <td><table width="100%" border="0" cellspacing="0">
              <tr>
                <td><img src="images/buy3.gif" width="635" height="38" />
                    <p>早上好：${user.uname }<c:if test="${user.usex=='男' }">先生</c:if><c:if test="${user.usex=='女' }">女士</c:if>！您离结算还有最后一步啦！</p></td>
              </tr>
              <tr>
               ...
               <c:if test="${cart==null}">
                 <table width="100%" border="0" cellspacing="0">
				   ...
				   <hr/> 
				   <p style="text-align:center"><a href="${pageContext.request.contextPath }/DispacherServlet.do?type=final"><img src="images/finalbutton.gif" width="204" height="51" border="0" /></a></p></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
